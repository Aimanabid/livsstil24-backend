...
const placementData = [
  ...
  { name: 'Footer Banner',  position_key: 'footer_banner',  cpm_rate: 50.00,  max_ads: 1, description: 'Alla sidor — banner längst ner' },
  { name: 'Category Top',   position_key: 'category_top',   cpm_rate: 60.00,  max_ads: 1, description: 'Kategorisidor — banner under rubriken' },
...
const adData = [
  ...
  {
    title: 'Resebyrån Äventyr — Sommarresor',
    alt_text: 'Boka din drömresa nu — exklusiva priser',
    image_url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&auto=format&fit=crop',
    link_url: 'https://example.com/aventyr',
    ad_type: 'image',
    placement_id: placements['category_top'].id,
    customer_id: customers['johan@aventyr.se'].id,
    status: 'active',
    start_date: '2026-05-01',
    end_date: '2026-08-31',
    impressions: 5200,
